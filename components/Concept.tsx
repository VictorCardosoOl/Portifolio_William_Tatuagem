...
const Concept: React.FC = () => {
  ...
  return (
    <section ref={containerRef} className="relative w-full py-16 md:py-24 px-8 md:px-12 lg:px-16 bg-paper-light dark:bg-[#181818] transition-colors duration-1000">
